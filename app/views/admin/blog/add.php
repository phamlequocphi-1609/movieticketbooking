                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Add Blog</h5>
                                    </div>
                                    ...
                                    <?php endif; ?>
                                    <form action="<?php echo __WEB_ROOT__ ?>/blog/create" enctype="multipart/form-data"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea name="heading" id="" class="form-control"
                                                value="<?php echo isset($_POST['heading']) ? $_POST['heading'] : ''; ?>"></textarea>
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Content</label>
                                            <textarea name="content" class="form-control"
                                                value="<?php echo isset($_POST['content']) ? $_POST['content'] : ''; ?>"></textarea>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100" type="submit">Create Blog</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
