                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Add Seat Type</h5>
                                    </div>
                                    ...
                                    <form action="<?php echo __WEB_ROOT__ ?>/seatType/create"
                                        class="row g-3 needs-validation" novalidate method="POST">
                                        <div class="col-12">
                                            <label class="form-label">Seat Type</label>
                                            <input type="text" name="seat_type" class="form-control"
                                                value="<?php echo isset($_POST['seat_type']) ? $_POST['seat_type'] : ''; ?>">
                                        </div>
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100" type="submit">Create Seat
                                                Type</button>
                                        </div>
                                    </form>
                                </div>
