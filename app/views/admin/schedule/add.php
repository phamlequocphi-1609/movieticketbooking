                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Add Schedule</h5>
                                    </div>
                                    ...
                                    <?php endif; ?>
                                    <form action="<?php echo __WEB_ROOT__ ?>/schedule/create"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="date"
                                                value="<?php echo isset($_POST['schedule_date']) ? $_POST['schedule_date'] : ''; ?>"
