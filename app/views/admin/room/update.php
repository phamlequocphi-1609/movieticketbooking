                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Update Room</h5>
                                    </div>
                                    ...
                                    <form action="<?php echo __WEB_ROOT__?>/room/update/<?php echo $room['id']?>"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select name="cinema_id" class="form-control form-control-line">
                                                ...
                                                < <option value="<?php echo $value['id']; ?>"
                                                    <?php echo $value['id'] == $room['cinema_id'] ? 'selected' : ''; ?>>
                                                    <?php echo ($value['name']); ?>
                                                    </option>
                                                    <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                value="<?php echo isset($_POST['name']) ? $_POST['name'] : $room['name'] ?>">
                                        </div>
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100" type="submit">Update Room</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
