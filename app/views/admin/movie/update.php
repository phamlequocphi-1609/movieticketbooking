                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Update Movie</h5>
                                    </div>
                                    ...
                                    <?php endif; ?>
                                    <form action="<?php echo __WEB_ROOT__ ?>/movie/update/<?php echo $movie['id']?>"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea name="description" id="" class="form-control" rows="5"
                                                value="<?php echo isset($_POST['description']) ? $_POST['description'] : $movie['description']?>">
                                            <?php echo isset($_POST['description']) ? $_POST['description'] : trim($movie['description'])?>
                                            </textarea>
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Trailer</label>
                                            <video width="150" controls class="d-block mb-2">
                                                <source
                                                    src="<?php echo __WEB_ROOT__?>/public/upload/admin/movie/trailer/<?php echo $movie['trailer']?>">
                                            </video>
                                            <input type="file" name="trailer" class="form-control"
                                                value="<?php echo isset($_POST['trailer']) ? $_POST['trailer'] : $movie['trailer']; ?>">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Genre</label>
                                            <input type="text" name="genre" class="form-control"
                                                value="<?php echo isset($_POST['genre']) ? $_POST['genre'] : $movie['genre'] ?>">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Release Date</label>
                                            <input type="date" name="release_date" class="form-control"
                                                value="<?php echo isset($_POST['release_date']) ? $_POST['release_date'] : $movie['release_date'] ?>">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Duration</label>
                                            <input type="text" name="duration" class="form-control"
                                                value="<?php echo isset($_POST['duration']) ? $_POST['duration'] : $movie['duration']; ?>">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Format</label>
                                            <input type="text" name="format" class="form-control"
                                                value="<?php echo isset($_POST['format']) ? $_POST['format'] : $movie['format']; ?>">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Poster</label>
                                            <img width="100" class="d-block mb-2 text-center"
                                                src="<?php echo __WEB_ROOT__?>/public/upload/admin/movie/poster/<?php echo $movie['poster_image']  ?>"
                                                alt="">
                                            <input type="file" name="poster_image" class="form-control"
                                                value="<?php echo isset($_POST['poster_image']) ? $_POST['poster_image'] : $movie['poster_image']; ?>">

                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Age Rating</label>
                                            <input type="text" name="age_rating" class="form-control"
                                                value="<?php echo isset($_POST['age_rating']) ? $_POST['age_rating'] : $movie['age_rating']; ?>">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Content Rating</label>
                                            <textarea name="content_rating" class="form-control" rows="4"
                                                value="<?php echo isset($_POST['content_rating']) ? $_POST['content_rating'] : $movie['content_rating'] ?>">
                                              <?php echo isset($_POST['content_rating']) ? $_POST['content_rating'] : $movie['content_rating'] ?>  ?>
                                            </textarea>
                                        </div>
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100" type="submit">Update Movie</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
