                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Update Seat</h5>
                                    </div>
                                    ...
                                    <form action="<?php echo __WEB_ROOT__ ?>/seat/update/<?php echo $seat['id'] ?>"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select name="seat_type_id" class="form-control form-control-line">
                                                ...
                                                <?php foreach($seatTypes as $value) :?>
                                                <option value="<?php echo $value['id'] ?>"
                                                    <?php echo $seat['seat_type_id'] == $value['id']  ? "selected" : ''?>>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select name="room_id" class="form-control form-control-line">
                                                ...
                                                <option value="<?php echo $value['id']?>"
                                                    <?php echo $seat['room_id'] == $value['id'] ? "selected" : '' ?>>
                                                    <?php echo $value['name'] ?>
                                                </option>
                                                <?php endforeach;?>
                                                <?php endif; ?>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text"
                                                value="<?php echo isset($_POST['row']) ? $_POST['row'] : $seat['row']; ?>"
                                                name="row" class="form-control">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Number</label>
                                            <input type="text"
                                                value="<?php echo isset($_POST['number']) ? $_POST['number'] : $seat['number']; ?>"
                                                name="number" class="form-control">
                                        </div>

                                        <div class="col-12">
                                            <button class="btn btn-primary w-100" type="submit">Update Seat</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
