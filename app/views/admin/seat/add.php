                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Add Seat</h5>
                                    </div>
                                    ...
                                    <form action="<?php echo __WEB_ROOT__ ?>/seat/create"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text"
                                                value="<?php echo isset($_POST['row']) ? $_POST['row'] : ''; ?>"
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100" type="submit">Create Seat</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
